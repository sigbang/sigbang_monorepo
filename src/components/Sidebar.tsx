  ...
  return (
    <aside className="hidden sm:flex sm:flex-col sm:w-[200px] border-r border-[#eee] px-4 pt-6 gap-6" aria-label="사이드바 내비게이션">      
      <nav className="flex flex-col gap-3 text-[18px] text-[#333]">
        ...
        <Link className="flex items-center gap-2 hover:text-black focus:outline-none focus:ring-2 focus:ring-sky-500 rounded" href="/search"><SearchIcon size={24} />{t('nav.search')}</Link>
